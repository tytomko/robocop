...
bool robot_custom_interfaces__msg__status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_custom_interfaces.msg._status.Status", full_classname_dest, 42) == 0);
  }
  robot_custom_interfaces__msg__Status * ros_message = _ros_message;
  {  // id
...
PyObject * robot_custom_interfaces__msg__status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_custom_interfaces.msg._status");
