...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, rosbridge_test_msgs, action, TestResultOnly_SendGoal)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<rosbridge_test_msgs::action::TestResultOnly_SendGoal>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, rosbridge_test_msgs, action, TestResultOnly_GetResult)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<rosbridge_test_msgs::action::TestResultOnly_GetResult>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_action_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__ACTION_SYMBOL_NAME(rosidl_typesupport_cpp, rosbridge_test_msgs, action, TestResultOnly)() {
  return ::rosidl_typesupport_cpp::get_action_type_support_handle<rosbridge_test_msgs::action::TestResultOnly>();
}
